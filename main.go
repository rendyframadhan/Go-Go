...
import (
	...
	"learning-golang/service"
	"learning-golang/utils"
)

func main() {
	fmt.Println(constant.HELLO_GOLANG)

	result := utils.Add(2, 3)
	fmt.Println("Result: ", result)

	fmt.Println(service.DescribeString("asdf"))

	fmt.Print(constant.STRING + "Kocak")
	...
	// Boolean Operational
	fmt.Println("======== Boolean Operational ========")
	var amount = 10000

	var debit bool = amount > 9999

	fmt.Println(debit)

	// Array
	fmt.Println("======== Array, Slice, Maps And Loops ========")
